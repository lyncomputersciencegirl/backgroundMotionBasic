...
#include <GL/glx.h>
#include "myimage.h"
// when the same header file can be included two times 
// inside myimage.h, there is #ifndef, so it can be included one time
#include "myimage.h"
...
void init_opengl(void)
{
    ...
    //Texture map is made of rows and columns of colors 
...
{
    //move the background
    //x coordinates are moving right ward 
    g.tex.xc[0] += 0.001;
    g.tex.xc[1] += 0.001;
}
...
void render()
{
    // This is our main backgorund picture 
    glClear(GL_COLOR_BUFFER_BIT);
    ...
    // This is a new image class for testing 
